...
const float PROJECTILE_COLLIDER_RADIUS = 0.5f;
...
const PlayerInputState FLAG_PLAYER_INPUT_FORWARD = (UINT32)0b1;
const PlayerInputState FLAG_PLAYER_INPUT_BACKWARD = (UINT32)0b10;
const PlayerInputState FLAG_PLAYER_INPUT_ROTATE_LEFT = (UINT32)0b100;
const PlayerInputState FLAG_PLAYER_INPUT_ROTATE_RIGHT = (UINT32)0b1000;
const PlayerInputState FLAG_PLAYER_INPUT_FIRE_MACHINE_GUN = (UINT32)0b100000;
const PlayerInputState FLAGS_PLAYER_INPUT_MOVEMENT = (UINT32)0b1111;